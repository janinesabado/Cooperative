   ...
   <!--#############################################COSTUMER################################################################################################-->
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Components">
          ...
          <ul class="sidenav-second-level collapse" id="collapseComponents">
            <li>
              <a href="<?php echo base_url(); ?>add_costumer">Add Costumer</a>
            </li>
            <li>
	 ...
	 <!--#############################################STOCK################################################################################################-->	
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="payment">
          <a class="nav-link" href="<?php echo base_url(); ?>payment">
		   ...
		   <!--#############################################OUTSTANDING################################################################################################-->
		  <li class="nav-item" data-toggle="tooltip" data-placement="right" title="outstanding">
          <a class="nav-link" href="<?php echo base_url(); ?>outstanding">
